...
这次分享围绕如何使用 AI Agent 完成科研任务展开，以 Claude Code 为例，介绍从提示词到智能体的使用方式变化、工具调用与上下文管理、安装配置，以及如何通过 Skills 组织文献检索、实证分析、图表制作和论文写作等工作。

## 分享录像

- 录制名称：AI Agent上手教程
- 录制时间：2026-09-10 21:33:59
- [观看录像（腾讯会议，需登录）](https://meeting.tencent.com/crm/NoVZgrGz48)
